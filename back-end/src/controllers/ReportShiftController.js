const ReportShiftService = require("../services/ReportShiftService");

module.exports = {
  buscarTodos: async (req, res) => {
    let json = { error: "", result: [] };

    let turnos = await ReportShiftService.buscarTodos();
  ...
  buscarUm: async (req, res) => {
    ...
    let turno = await ReportShiftService.buscaMes(data);
